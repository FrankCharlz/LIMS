    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h4>Plots applications frequencies</h4>
                <div id="plot-apps-div"></div>
                <div id="user-apps-div"></div>

                <div class="row" style="margin: 24px 0; border-top: 1px solid grey; padding: 20px 0;">
                ...
                <?= $lava->render('BarChart', 'Users', 'user-apps-div') ?>
